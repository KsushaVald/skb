...
async function main() {
  let response = await dataRequest('http://localhost:3000/api/clients');
  console.log(response);
  sortDevelopment(response);
}
